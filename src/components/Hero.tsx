    ...
    >
      ...
      <div className="container mx-auto px-10 py-16 relative z-10">
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
          ...
          <div className="relative order-1 md:order-2 w-full max-w-lg mx-auto">
            {/* Floating solid circular elements */}
            <div className="absolute w-24 h-24 bg-blue-600/30 top-0 left-0 rounded-full animate-floating" />
            <div className="absolute w-24 h-24 bg-purple-600/30 bottom-0 right-0 rounded-full animate-floating delay-150" />
            <div className="absolute w-20 h-20 bg-green-500/30 top-4 right-4 rounded-full animate-floating delay-300" />
            <div className="absolute w-20 h-20 bg-yellow-500/30 bottom-4 left-4 rounded-full animate-floating delay-450" />
